              ...
              <div className="mb-8">
                ...
                <div className="mb-4 flex flex-col space-y-4">
                  <div className="flex">
                    ...
                    <div className="flex-1 flex">
                      <span className="text-xs py-2 px-2 bg-gray-200 text-gray-600">facebook.com/</span>
                      <input className="flex-1 shadow-inner p-3 border-2 border-gray-300 rounded-lg" type="text" name="facebook" placeholder="yourusername" onChange={(e) => setFacebook(e.target.value)}/>
                    </div>
                  </div>
                  <div className="flex">
                    <label className="w-1/3 text-sm font-medium text-charcoal-darker pr-2">Twitter</label>
                    <div className="flex-1 flex">
                      <span className="text-xs py-2 px-2 bg-gray-200 text-gray-600">twitter.com/</span>
                      <input className="flex-1 shadow-inner p-3 border-2 border-gray-300 rounded-lg" type="text" name="twitter" placeholder="yourusername" onChange={(e) => setTwitter(e.target.value)}/>
                    </div>
                  </div>
                  <div className="flex">
                    <label className="w-1/3 text-sm font-medium text-charcoal-darker pr-2">Instagram</label>
                    <div className="flex-1 flex">
                      <span className="text-xs py-2 px-2 bg-gray-200 text-gray-600">instagram.com/</span>
                      <input className="flex-1 shadow-inner p-3 border-2 border-gray-300 rounded-lg" type="text" name="instagram" placeholder="yourusername" onChange={(e) => setInstagram(e.target.value)}/>
                    </div>
                  </div>
                </div>
              </div>
