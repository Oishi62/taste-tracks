  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <div className="flex flex-col md:flex-row items-center mb-4 md:mb-0">
      <a className="flex title-font font-medium items-center text-gray-900 mb-2 md:mb-0 md:mr-4">
        <img className="h-12 w-auto rounded-xl" src="web_logo.png" alt=""/>
      </a>
      <p className="text-center md:text-left">TasteTracks: Where Food Meets Work</p>
    </div>
  ...
  <div className="container mx-auto flex px-5 py-5 md:flex-row flex-col items-center">
    <div className="lg:flex-grow flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <div className="flex justify-center">
        <button className="inline-flex text-black bg-green-400 py-2 px-4 focus:outline-none hover:bg-opacity-80 rounded-xl text-sm transition transform hover:-translate-y-1">Claim Account</button>
